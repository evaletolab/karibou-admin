    ...
    link: function(scope, $element, attr, ctrl, $transclude) {
        ...
        function update(event, next, last) {
          ...
          if(currentRoute&&
            ...
            currentView=currentRoute.$$route.view;
          }
          ...
          if (currentRoute && currentView && ! attr.ngView) {
            return;
          }

          if (attr.ngView && currentRoute && ! currentView) {
            scope.$broadcast('$viewContentCleared');
            $element.html('');
            cleanupLastView();
          }

          if (currentRoute && attr.ngView && ( ! currentView || attr.ngView !== currentView)) {
            return;
          }
