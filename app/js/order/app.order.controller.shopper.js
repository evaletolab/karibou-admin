...
OrderShopperCtrl.$inject=['$scope', '$routeParams','$log', '$controller','$q','order','config','user'];
function OrderShopperCtrl($scope,$routeParams, $log, $controller, $q, order, config, user) {
